...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TrafficLight}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} TrafficLight ,\, turn}%
\@pvspace{8.0pt}%
\@x{ States \.{\defeq} \{\@w{green} ,\,\@w{red} \}}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} TrafficLight ,\, turn {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@x{\@s{8.2} \.{\land} turn \.{=} 1}%
 \@x{\@s{8.2} \.{\land} TrafficLight\@s{7.30} \.{=} [ i \.{\in} 0 \.{\dotdot}
 1 \.{\mapsto}\@w{red} ]}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \.{\land} \A\, i \.{\in} 0 \.{\dotdot} 1 \.{:}
 TrafficLight [ i ] \.{\in} States}%
\@x{\@s{56.14} \.{\land}\@s{8.2} turn \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{ OtherTL ( a ) \.{\defeq} ( a \.{+} 1 ) \.{\%} 2}%
\@pvspace{16.0pt}%
 \@x{ Control \.{\defeq}\@s{4.1} \.{\land} TrafficLight [ turn ]
 \.{=}\@w{green}}%
\@x{\@s{56.60} \.{\land} turn \.{'} \.{=} OtherTL ( turn )}%
\@x{\@s{56.60} \.{\land} {\UNCHANGED} TrafficLight}%
\@pvspace{16.0pt}%
 \@x{ SwitchToRed \.{\defeq} \.{\land} TrafficLight [ OtherTL ( turn ) ]
 \.{=}\@w{green}}%
 \@x{\@s{75.77} \.{\land} TrafficLight \.{'} \.{=} [ TrafficLight {\EXCEPT}
 {\bang} [ OtherTL ( turn ) ] \.{=}\@w{red} ]}%
\@x{\@s{75.77} \.{\land} {\UNCHANGED} turn}%
\@pvspace{8.0pt}%
 \@x{ SwitchToGreen \.{\defeq} \.{\land} TrafficLight [ OtherTL ( turn ) ]
 \.{=}\@w{red}}%
 \@x{\@s{85.27} \.{\land} TrafficLight \.{'} \.{=} [ TrafficLight {\EXCEPT}
 {\bang} [ turn ] \.{=}\@w{green} ]}%
\@x{\@s{85.27} \.{\land} {\UNCHANGED} turn}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} Control}%
\@x{\@s{16.4} \.{\lor} SwitchToGreen}%
\@x{\@s{16.4} \.{\lor} SwitchToRed}%
\@pvspace{8.0pt}%
 \@x{ NeverBothGreen \.{\defeq} TrafficLight [ 0 ] \.{=}\@w{red} \.{\lor}
 TrafficLight [ 1 ] \.{=}\@w{red}}%
\@pvspace{8.0pt}%
 \@x{ SwitchOnlyAfterGreen \.{\defeq} {\Box} [ TrafficLight [ turn ]
 \.{=}\@w{red} \.{\implies} turn \.{'} \.{=} turn ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{ SwitchNotDirectlyToGreen \.{\defeq} {\Box} [ \A\, i \.{\in} 0
 \.{\dotdot} 1 \.{:}}%
\@x{\@s{149.23} \.{\land} TrafficLight [ i ] \.{=}\@w{green}}%
\@x{\@s{149.23} \.{\land} TrafficLight [ OtherTL ( i ) ] \.{=}\@w{red}}%
\@x{\@s{149.23} \.{\implies}}%
\@x{\@s{149.23} \.{\lor} TrafficLight \.{'} \.{=} TrafficLight}%
 \@x{\@s{149.23} \.{\lor} TrafficLight \.{'} \.{=} [ TrafficLight
 {\EXCEPT}\@s{4.1} {\bang} [ i ] \.{=}\@w{red} ] ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{ SwitchToGreenWhoseTurnItIs \.{\defeq} {\Box} [ \A\, i \.{\in} 0
 \.{\dotdot} 1 \.{:}}%
\@x{\@s{158.41} \.{\land} TrafficLight [ i ] \.{=}\@w{red}}%
\@x{\@s{158.41} \.{\land} TrafficLight [ OtherTL ( i ) ] \.{=}\@w{red}}%
\@x{\@s{158.41} \.{\implies}}%
\@x{\@s{158.41} \.{\lor} TrafficLight \.{'} \.{=} TrafficLight}%
 \@x{\@s{158.41} \.{\lor} TrafficLight \.{'} \.{=} [ TrafficLight {\EXCEPT}
 {\bang} [ turn ] \.{=}\@w{green} ] ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{ AlwaysEventuallyGreen \.{\defeq} {\Box} ( \A\, i \.{\in} 0 \.{\dotdot} 1
 \.{:} TrafficLight [ i ] \.{\defeq}\@w{red} \.{\implies} {\Diamond}
 TrafficLight [ i ] \.{=}\@w{green} )}%
\@pvspace{16.0pt}%
\@x{}%
\@y{\@s{0}%
 Sei \ensuremath{Ampel} 1 am \ensuremath{Zug}. Dann kann \ensuremath{Ampel} 2
 erst dann dran kommen, nach dem \ensuremath{Ampel} 1 auf \ensuremath{Gr}ün
 geschaltet wurde.
}%
\@xx{}%
\@pvspace{16.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 20 15:38:46 \ensuremath{CET} 2024 by \ensuremath{moritz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Dec} 30 18:44:33
 \ensuremath{CET} 2023 by \ensuremath{moritz
}%
\end{cpar}%
\end{lcom}%
\end{document}
